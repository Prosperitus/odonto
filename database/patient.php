...
public function add($patient){
 ...
 public function searchAutocomplete($filter){

    $sql = "SELECT id,name,surname FROM `odt_soft`.`patient`
            WHERE name LIKE :name OR surname LIKE :surname  OR social_security = :cpf OR health_insurance = :health_insurance OR responsible1 = :responsible_Name1 OR responsible2 =:responsible_Name2 OR email LIKE :patient_email 
            ORDER by patient.name LIMIT 5;";
 ...
 public function edit($patient) {
	...
	try{
    $sql = "UPDATE patient SET  name = :name, 
	surname = :surname, birthdate = :birthdate, gender = :gender, social_security = :socialSecurity, address = :address,
	neighborhood = :neighborhood, city = :city, state = :state, zip_code = :cep, health_insurance = :healthPlan, 
	responsible1 = :responsibleName,responsible2 = :responsible2, telephone_r1 = :responsiblePhone, telephone_r2 = :responsiblePhone2, clinic = :clinic,      
	physician_assistant = :physician_assistant,	name_phy_assistant = :medicalassistant, telephone_phy_assistant = :telephone_phy_assistant, speciality_phy_assistant = :speciality_phy_assistant, email = :email WHERE id = :id";
	$gpmedicalassistant = '';
	$gptelephone_phy_assistant = '';
	$gpspeciality_phy_assistant = '';
        //gp significa get pacient

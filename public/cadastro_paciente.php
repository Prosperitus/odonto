...
?>
  ...
  <script>
    ...
    <!--CPF-->
        ...
        <div id="medico_responsavel" style="display:none">
         <!--NOME DO MÉDICO-->
          <div class="input-field col s5">
            <i class="material-icons prefix">supervisor_account</i>
            <input name="nome_medico" id="nome_medico" pattern="[a-zA-ZÀ-úẽẼ\s]+$" title="Apenas Letras" type="text" class="validate" required>
         ...
         <!--TELEFONE DO MÉDICO-->
          <div class="input-field col s5">
            <i class="material-icons prefix">phone</i>
            <input name="telefone_medico" id="telefone_medico" pattern="\([0-9]{2}\) [0-9]{4,6}-[0-9]{3,4}$" title="(00) 00000-0000" type="text" class="validate" required>
         ...
         <!--ESPECIALIDADE DO MÉDICO-->
            <div class="input-field col s5">   
              <i class="material-icons prefix">supervisor_account</i>
              <input name="especialidade_medico" id="especialidade_medico" pattern="[a-zA-ZÀ-úẽẼ\s]+$" title="Apenas Letras" type="text" class="validate" required>
        ...
        <div class="input-field col s5" style="margin-bottom: 13px;margin-top: -20px;">
          <p>
            ...
            <label for="medico" onclick="MedicoResponsavel('medico_responsavel')">Médico Responsavel</label>
          </p>
        </div>

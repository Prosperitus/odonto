...
<!--CLASS/FORM-->
    ...
    <!--CPF-->
        ...
        <div class="input-field col s5">
          <i class="material-icons prefix">supervisor_account</i>
          <input name="nome_responsavel 2" id="nome_responsavel 2" type="text" class="validate">
          <label for="nome_responsavel 2">Nome do Responsável 2</label>
        </div>
        ...
        <div class="input-field col s5">
          <i class="material-icons prefix">phone</i>
          <input name="telefone_responsavel 2" id="telefone_responsavel 2" type="text" class="validate">
          <label for="telefone_responsavel 2">Telefone do Responsável 2</label>
        </div>
        ...
        <div class="input-field col s9">
            <p>
              <input id="Médico_Assistente"type="checkbox" name="checkbox" value="checkbox" onclick="bloqueio()" />
              <label for="Médico_Assistente">Médico Assintente</label>
            </p>
             </div>
        ...
        <div id="divprincipal" style="display: none" >
          ...
          <div class="input-field col s6">
            <i class="material-icons prefix">web</i>
            <input name="especialidade" id="especialidade" type="text" class="validate">

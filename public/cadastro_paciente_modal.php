  ...
  <script src="../validation/validacao_cpf.js"></script>
    ...
    <!--CLASS/FORM-->
    <div class="row">
      <form class="col s11 m12" id="formAddPatient">

        <!--TITULO-->
        <div style="height:80px;background-color: #03a9f4; margin-bottom:50px;">
        <h3 style=" font-size:40px; text-align: center;color:white; padding:20px;" class="center">Cadastro de Paciente</h3>
      ...
      <div id="div_medico" style="display:none">
        ...
        <div class="input-field col s9">
          <button class="btn waves-effect waves-light light-blue" type="submit" id="btnAddPatientModal" name="action">Confirmar Cadastro

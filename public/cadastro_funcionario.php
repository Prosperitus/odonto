  ...
  <body class = "light-blue lighten-5">
    ...
    <div class="row main margemCentro">
  	...
  	<!--SENHA-->
        ...
        <div class="input-field col s5">
          <i class="material-icons prefix">vpn_key</i>
          <input id="funcionario_confirma_senha" type="password" class="validate" minlength="6" name="funcionario_confirma_senha" required>
          <label for="funcionario_confirma_senha">Confirmar Senha</label>
        </div>
